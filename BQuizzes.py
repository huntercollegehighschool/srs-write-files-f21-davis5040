...
a.write('Quiz' + str(quizname) + "\n")
b.write('Answers to ' + str(quizname))
...
for questionNum in range(50):  # loop through each of the 50 states
  ...
  a.write(str(questionNum) + ". " + states[questionNum] + "\n")
  ...
  b.write(questionNum, ")", alp[answer], " ", choices[answer], "\n")
